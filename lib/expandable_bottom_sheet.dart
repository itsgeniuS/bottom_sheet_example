...
class ExpandableBottomSheetExample extends StatefulWidget {
  const ExpandableBottomSheetExample({Key? key}) : super(key: key);

  @override
  ExpandableBottomSheetState createState() => ExpandableBottomSheetState();
}

class ExpandableBottomSheetState extends State<ExpandableBottomSheetExample> {
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                IconButton(
                  ...
                  onPressed: () => setState(() {
                    _expansionStatus = key.currentState!._expansionStatus;
                  }),
                ),
                // IconButton(
